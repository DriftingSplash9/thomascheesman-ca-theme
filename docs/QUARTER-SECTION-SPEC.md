...
| **3D-P2 — life & juice** | Dust particles, tire tracks, honk + engine hum (WebAudio, muted default), chimney smoke, mailbox flag, billboard quotes in 3D. **+ the art pass path:** proportion/silhouette pass, gradient/texture materials, optional AI-generated GLB swaps (Meshy/Tripo) per building. | |
