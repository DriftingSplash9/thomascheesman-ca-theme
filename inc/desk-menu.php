...
>
    <div class="tc-desk__frame" style="--desk-hero: url('<?php echo esc_url( $hero_url ); ?>');">
        ...
        <div class="tc-desk__hotspot" id="tc-desk-bitcoin" style="left:80.33%; top:39.98%; width:19.17%; height:18.26%; --hot-x:80.33; --hot-y:39.98; --hot-w:19.17; --hot-h:18.26; --hot-png: url('https://lightgoldenrodyellow-dugong-336485.hostingersite.com/wp-content/uploads/2026/05/bitcoin.png');" aria-label="Bitcoin Standard and Broken Money">
