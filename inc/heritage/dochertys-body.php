<?php
/**
 * Heritage line body — The Dochertys (and McIvers).
 *
 ...
 * template; hero metadata lives at page-dochertys.php.
 *
 * Note: carries the McIver thread inside the same page (Granny Docherty's
 * maiden name) since the McIvers don't have enough on-record material
 * yet to warrant their own spoke.
 */
...
<h3>Granny Docherty</h3>
<p>Elizabeth Annie McIver was born March 20, 1919, in Saltcoats, Saskatchewan, and died April 24, 1988, in Edmonton at 69. Her funeral was at the Eastminster Presbyterian Church in Edmonton. She brought a whole second inheritance into this family: the McIver line. She was the daughter of James Roderick McIver and Mary Ann Birse &mdash; her mother a great-grandmother of mine who lived to 102 &mdash; and her grandparents were Donald George McIver of the Isle of Lewis and Elizabeth &ldquo;Lizzie&rdquo; Campbell of South Uist, who married at Earlswood, Saskatchewan, in 1888. The McIvers, Campbells, and Camerons were Hebridean and Highland Scots, cleared off Lewis, South Uist, and the Moray coast and carried to the southeastern Saskatchewan prairie in the 1880s. It is, unusually, the best-documented branch in the whole family &mdash; deep enough to deserve its own telling.</p>

<p class="heritage-line__readmore">
    <a href="<?php echo esc_url( home_url( '/family/heritage/dochertys/mcivers' ) ); ?>">Read the full McIver, Campbell &amp; Cameron story &mdash; three Hebridean streams, Lewis and South Uist and Moray to the prairie &rarr;</a>
</p>
