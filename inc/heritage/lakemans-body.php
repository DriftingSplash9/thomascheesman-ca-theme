<?php
/**
 * Heritage line body — The Lakemans.
 *
 ...
 * template; hero metadata lives at page-lakemans.php.
 *
 * The biggest spoke in terms of prose because the Lakeman story spans
 * Indonesia, the Netherlands, Venezuela, England, Kuwait, Singapore,
 * and Calgary — most of it from a long email Martin (Thomas's
 * biological father) wrote out for the family record.
 */
