...
<main id="primary" class="site-main heritage-page heritage-spoke person-spoke person-spoke--daniel">
    ...
    <article class="heritage-lines">
        ...
        <?php if ( tc_user_is_family() ) : // OD-1/PRIV-1: whole page gated to family ?>
            ...
            <?php
            // Photo wall — Daniel. (Whole page is already gated to family
            // above — OD-1.) 222 photos from inc/gallery-daniel.php (restored
            // from git 629dd99). The 9999 bucket catches items Thomas hasn't
            // year-tagged yet. Renders as a peek-behind-cover wall.
