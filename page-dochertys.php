 ...
 *   - Slug: dochertys
 *   - Parent: Heritage  →  /family/heritage/dochertys/
 *
 * Carries the McIver thread inside the same page (Granny Docherty's
...
<main id="primary" class="site-main heritage-page heritage-spoke heritage-spoke--dochertys">

    <section class="page-hero">
        <div class="container">
            <a class="heritage-page__back" href="<?php echo esc_url( home_url( '/family/heritage' ) ); ?>">&larr; The Families</a>
            <span class="page-hero__eyebrow">Family line 02 of 05</span>
            <h1 class="page-hero__title kinetic-text">The Dochertys</h1>
    ...
    <article class="heritage-lines">
        <div class="container container--narrow">
            ...
            <section class="heritage-line heritage-line--spoke scroll-animate" id="dochertys">
