 ...
 *   - Slug: haistes
 *   - Parent: Heritage  →  /family/heritage/haistes/
 *
 * Melanie's father's side. Yorkshire textile-and-coal stock that
 * emigrated to a Saskatchewan homestead around 1900 and, three
 * generations later, settled across Alberta.
 */

get_header(); ?>

<main id="primary" class="site-main heritage-page heritage-spoke heritage-spoke--haistes">

    <section class="page-hero">
        <div class="container">
            <a class="heritage-page__back" href="<?php echo esc_url( home_url( '/family/heritage' ) ); ?>">&larr; The Families</a>
            <span class="page-hero__eyebrow">Family line 05 of 05</span>
            <h1 class="page-hero__title kinetic-text">The Haistes</h1>
    ...
    <article class="heritage-lines">
        <div class="container container--narrow">
            ...
            <section class="heritage-line heritage-line--spoke scroll-animate" id="haistes">
            ...
            <?php tc_render_heritage_siblings( 'haistes' ); ?>
