...
<main id="primary" class="site-main hcs-page">
    ...
    <section class="page-hero">
        <div class="container">
            <span class="page-hero__eyebrow">The Ultra Rare condition</span>
    ...
    <article class="about-body">
        <div class="container container--narrow">
            ...
            <section class="about-section scroll-animate">
                ...
                <p>The kitchen went first, and the kitchen was where I lived. I started cooking at The Keg in 2002 to pay my way through school, part time on the line while I finished Power Engineering in 2003. Then I could not be hired as a power engineer or a gas plant operator: a pre-existing rare disorder shut both doors before I got to an interview, and I would go on to give the place eleven years. The Keg offered me assistant kitchen manager instead. I did that for two years, so it was four years after being hired that I was handed the kitchen, and I ran it for the seven after that. In 2011 I began my schooling for the apprenticeship at SAIT. I finished in the fall of 2012. Eventually I had to move on to try a different angle and that's when I started as Head Chef at Ric's Grill the day Patience was born, ten days late.</p>
            ...
            <section class="about-section scroll-animate">
                ...
                <p>Back to the story&hellip; It gave me the family record. Since I left the kitchen I have sporadically used my time putting together the family history &mdash; all the way back to the 1600s on a couple branches; my own thread through all of this is <a href="<?php echo esc_url( home_url( '/family/thomas' ) ); ?>">the long way round</a>. The long-form research goes on YouTube as documentaries. The condensed versions live in the <a href="<?php echo esc_url( home_url( '/family/heritage' ) ); ?>">heritage section of this site</a>. I don't know if anyone will read it but it is here. Perhaps one of my kids will take a trip on the way-back-machine and fill a desire to learn where they came from. Our families are older, fragile, and smaller.</p>
            ...
            <section class="about-section scroll-animate">
                ...
                <p>The HCS-causing mutations are clustered in the very last exon of NOTCH2. (I don't know if 2 of us have the same exact mutation, some intergenerational afflicted families should have the same mutation though.) They cut the protein short, and the piece that gets cut off is called the PEST domain &mdash; proline-glutamate-serine-threonine, hence P-E-S-T. (Just don't ask why the glutamate = E, it is a mystery to me) The PEST tail is the cell's expiry sticker. It tells the cleanup machinery: when this protein has done its job, throw it out. Without the sticker, the protein is no longer flagged for removal. It lingers. The signal stays on too long. In bone, that means more osteoclasts &mdash; bone-breakdown cells &mdash; and not enough rebuild. The skeleton tilts toward demolition. The demolition crew runs without oversight &mdash; a metaphor I picked up from the literature and now think about most days.</p>
