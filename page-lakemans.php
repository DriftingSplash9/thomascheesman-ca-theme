 ...
 *   - Slug: lakemans
 *   - Parent: Heritage  →  /family/heritage/lakemans/
 *
 * The biggest spoke in terms of prose because the Lakeman story
 * spans Indonesia, the Netherlands, Venezuela, England, Kuwait,
 * Singapore, and Calgary — most of it from a long email Martin
 * (Thomas's biological father) wrote out for the family record.
 */

get_header(); ?>

<main id="primary" class="site-main heritage-page heritage-spoke heritage-spoke--lakemans">

    <section class="page-hero">
        <div class="container">
            <a class="heritage-page__back" href="<?php echo esc_url( home_url( '/family/heritage' ) ); ?>">&larr; The Families</a>
            <span class="page-hero__eyebrow">Family line 03 of 05</span>
            <h1 class="page-hero__title kinetic-text">The Lakemans</h1>
    ...
    <article class="heritage-lines">
        <div class="container container--narrow">
            ...
            <section class="heritage-line heritage-line--spoke scroll-animate" id="lakemans">
