		...
		<div class="container container--narrow">
			...
			<section class="about-section scroll-animate">
				...
				<details class="thomas-fold">
					...
					<p>My friends come back to me now as a roll call, town by town, the way they arrived. In Turner Valley there were Brian and Dallas, the twins in the corner house, and Adam across the alley; Stacy and Judy next door one way, Crystal next door the other &mdash; my hopeless grade-four crush &mdash; and a second Judy down the street, who was my first kiss. Around Teepee Creek there was Adam and Ryan, and Robie and his brother Justin, who was one of the closest I had. In LaGlace it was tag and bikes with Dallas and Char and Danita and Clayton, and in Valleyview, Crystal and James and Bernard and Lester and Ryan. Most of them are distant to me now; I&rsquo;ll be honest that I&rsquo;ve never been much good at holding on. It&rsquo;s one of the things you learn from moving as often as we did &mdash; to live in the present and not grieve what you can&rsquo;t reach, and that once you&rsquo;ve moved on you may as well be all the way gone.</p>
			...
			<!-- ===================== INTERLUDE: MUSTANG ===================== -->
			<section class="about-section scroll-animate">
				<p class="thomas-era">Interlude</p>
				<details class="thomas-fold">
			...
			<section class="about-section scroll-animate">
				...
				<h2 class="about-section__heading">Grande Prairie, and the wall</h2>
				...
				<p>In 1999 I finished high school and moved to Grande Prairie &mdash; the first move in this whole story that I made on my own. The doctors had never left me much room to plan a life: twelve years, they&rsquo;d said, and no children, and a wheelchair coming young, and behind all of it the strange dare one of them had handed me &mdash; that so little was known about my disease that one day I would have to become its expert myself. So I enrolled in a Bachelor of Science and went after it like a man with something to prove, which I was: analytical chemistry, biology, genetics, and physics thrown in purely to understand how the universe is bolted together. I wanted to be the expert nobody else could be for me.</p>
				...
				<details class="thomas-fold">
					...
					<p>A young town with money in its pockets also pulls in good music, and I caught more of it than I had any right to: The Trews and Finger Eleven and Nickelback, Steve Miller Band, Wyclef Jean, Merle Haggard, Bryan Adams, the Backstreet Boys, the Beach Boys &mdash; Shania Twain herself came through. And Ti&euml;sto, which I still can&rsquo;t quite believe happened, where I went with a friend&rsquo;s ex and her friend and caught an early glimpse of a new collaborator of his you may have heard of: Haddaway.</p>
			...
			<section class="about-section scroll-animate">
				...
				<details class="thomas-fold">
					...
					<p>The reward for management was the trips &mdash; the Keg Cups, the wine tastings, the courses on food and pairings, a few days touring the Kelowna wineries where we somehow ended up eating at a Keg every single time &mdash; but the best of them were the houseboat runs on the Shuswap. We ran them as themed tasting days: whisky one afternoon, sake the next, five vintages of a single wine lined up side by side to argue over. One year KC and I built a contraption we christened the Kegashuk, for the sole and holy purpose of holding our booze.</p>
				...
				<p>And somewhere in those years, in 2011, Melanie came back into my life through a computer screen. We&rsquo;d been apart a long time by then &mdash; when we first dated she had needed to get out of the Peace Country and I had needed to stay put and stable, and that was the fault line that split us, though I told myself that if it was meant to be it would find its way back one day. I&rsquo;d visited Edmonton a few times in between and kept her at arm&rsquo;s length the whole while, for reasons I&rsquo;ll come to. It took two tries to crack me open. But the second time she found me, I think I already knew how it would end.</p>
			</section>
			...
			<section class="about-section scroll-animate">
				...
				<p>Daniel arrived in 2015. Melanie and I married on the second of July, 2016, in Calgary, with Leah &mdash; who had introduced us all those years before &mdash; standing up to perform the service; and the truest thing I can tell you about the day is that the mosquitoes were so thick the photographer could barely make the pictures happen. Faith came in 2017. Three children in five years &mdash; three children I had been told, plainly and more than once, that I would never have.</p>

				<p>I won&rsquo;t pretend those years were kind to me. I was in so much pain that I could barely be present in them: my feet had collapsed and grown spurs of bone straight out the bottoms, so that every step landed on a stone, and even after a surgeon trimmed them away it took two years for the calluses to settle enough that I stopped feeling it. Pain is noise, and there is only so much of it a mind can carry and still think &mdash; I love turning an idea over, and you cannot turn anything over with that much static running underneath you, let alone keep enough quiet left over to truly be there for the people you love. It has taken me twenty-five years to learn to manage that noise, and it was a hard, slow lesson. But no matter how bad it got, I made every awards night and every birthday and every holiday. I was there.</p>

				<h3 class="about-section__subheading">The spark</h3>
				<p>Becoming a father, after a lifetime of being told it wasn&rsquo;t in the cards, has been the plain unarguable blessing of my life &mdash; and the returned time to actually be with them is better than anything I could have pictured. I think often about why any of us are here at all, and the honest answer is that none of us knows, and that not-knowing is the void people fill with religion, or with drink and drugs, or with their careers. Somewhere life learned to copy itself, and the saving grace is that it never copied perfectly &mdash; the imperfect copies, the mutants like me, whose code got nudged by something in the world, a thin place in the atmosphere letting the radiation through, a restless sun, who can say &mdash; those flawed copies are the whole engine of the thing. Life is a flame we each carry back to that first spark, which means that at some distance every living thing is a cousin of mine, and I try to honour anything that lives or has lived on the strength of that shared fire. I felt it as a chef, too, about the food itself &mdash; the care folded into the soil and the planting and the harvest, every hand a thing passes through before it reaches a plate. Carrying the spark this far is the treasure of a life. Passing it on is the larger treasure still, and one day, if I&rsquo;m lucky, I&rsquo;ll watch my own kids pass it on, and that will be the brightest flame of all.</p>
			...
			<section class="about-section scroll-animate">
				...
				<p>So far, so good. My back curves a little more than it did, and my shoulders are all but gone &mdash; the collarbones and the shoulder blades have nearly dissolved &mdash; and it&rsquo;s the lost motion, more than the pain, that I mind. There&rsquo;s no pill that grows a shoulder back, so I do my physiotherapy and I get on with it. This is the hinge of the whole story &mdash; the body finally taking the kitchen, and very nearly taking the rest of me with it. What I told myself, over and over through that year, was the simplest thing in the world: I&rsquo;ve got this. I can get back up, and I can be the best parent I&rsquo;m able to be by being here, for as long as I&rsquo;m able to be here.</p>
			...
			<section class="about-section scroll-animate">
				...
				<p>If the three of you are reading this one day, this part is yours. The rest of the page is the long road I walked to get to you; this is only the short, plain truth of how I feel about it. Carrying my spark this far has been the treasure of my life, and watching each of you carry yours will be the greater one. I hope you each find your purpose the way I eventually found mine &mdash; it took me a very long time, and it took your mom to crack me open, so respect her for that alone if for nothing else.</p>
