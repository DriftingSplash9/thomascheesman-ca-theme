<?php
/**
 * ARCHIVE — Timeline (jeep / parallax version)
 *
 * Frozen snapshot of the parallax-jeep timeline as of 2026-05-01.
 * NOT active and NOT auto-applied — WordPress matches `page-{slug}.php`
 * by slug, and there is no page with slug "timeline-jeep". Kept for
 * reference and possible BHAG revival.
 *
 * Active timeline lives in page-passport.php (slug `/passport`).
 *
 * Original docblock follows.
 *
